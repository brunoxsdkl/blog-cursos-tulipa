  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="relative border-b border-rose-200/20 bg-white/40 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center h-8 sm:h-8">
          <div className="flex items-center gap-2 sm:gap-5">
            <a href="https://www.instagram.com/andreia.tulipa/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-[11px] uppercase tracking-[0.12em] font-medium text-rose-500/70 hover:text-rose-700 transition-colors shrink-0">
              ...
              <span className="hidden sm:inline">@andreia.tulipa</span>
            </a>
            <a href="https://www.instagram.com/tulipaessencias/?hl=pt" target="_blank" rel="noopener noreferrer"
              ...
              <span className="hidden sm:inline">tulipa essências</span>
            </a>
            ...
            <a href="https://www.youtube.com/@Ateli%C3%AAA_Tulipa" target="_blank" rel="noopener noreferrer"
              ...
              <span className="hidden sm:inline">@Ateliê Tulipa</span>
            </a>
            <span className="w-px h-3 bg-rose-200/40 shrink-0" />
