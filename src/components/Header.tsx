    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-28 sm:h-32">
          ...
          <div className="hidden md:flex flex-col items-end gap-1.5 flex-shrink-0 ml-auto">
            <a
              href="https://www.instagram.com/andreia.tulipa/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-rose-400 hover:text-rose-600 transition-colors group"
            >
              ...
              <span className="text-sm uppercase tracking-[0.15em] font-medium text-rose-700/80 group-hover:text-rose-900 transition-colors">@andreia.tulipa</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-sm uppercase tracking-[0.15em] font-medium text-rose-700/80 group-hover:text-rose-900 transition-colors">tulipa essências</span>
            </a>
            <a
