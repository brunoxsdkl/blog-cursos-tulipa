...
const hero = {
  ...
  tipo: "img" as const,
  legenda: "Instrutora Dona Tulipa",
}

const verticais = [
  { src: "/foto-secundaria.jpg", tipo: "img" as const, legenda: "Produção artesanal" },
  { src: "/video-principal.mp4", tipo: "video" as const, legenda: "Aula principal" },
]

const quadrados = [
  { src: "/video-quarta.mp4", tipo: "video" as const, legenda: "Momento do curso" },
  { src: "/video-whatsapp-1.mp4", tipo: "video" as const, legenda: "Bastidores" },
  { src: "/video-whatsapp-2.mp4", tipo: "video" as const, legenda: "Técnicas exclusivas" },
  { src: "/video-whatsapp-3.mp4", tipo: "video" as const, legenda: "Finalização" },
]
    ...
    <section className="mb-14">
      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-6 space-y-4 sm:space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          ...
          {/* VIDEO PRINCIPAL 9:16 à direita */}
          <div className="sm:col-span-1 sm:row-span-2">
