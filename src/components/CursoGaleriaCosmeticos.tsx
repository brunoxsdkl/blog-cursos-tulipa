...
const hero = {
  ...
  tipo: "img" as const,
  legenda: "Curso de Cosméticos & Perfumes",
}

const verticais = [
  { src: "/cosmeticos-foto-1.jpg", tipo: "img" as const, legenda: "Produtos finalizados" },
  { src: "/cosmeticos-destaque.mp4", tipo: "video" as const, legenda: "Produção dos cosméticos" },
]

const quadrados = [
  { src: "/cosmeticos-video-01.mp4", tipo: "video" as const, legenda: "Mistura dos ingredientes" },
  { src: "/cosmeticos-video-02.mp4", tipo: "video" as const, legenda: "Fragrâncias e essências" },
  { src: "/cosmeticos-video-03.mp4", tipo: "video" as const, legenda: "Embalagem artesanal" },
  { src: "/cosmeticos-video-04.mp4", tipo: "video" as const, legenda: "Resultado final" },
]
...
function CardSquare({ src, tipo, legenda, index, onClick }: {
  src: string; tipo?: "img" | "video"; legenda: string; index: number; onClick: () => void
}) {
  const [ref, show] = useFadeIn(index * 70)
  return (
...
export default function CursoGaleriaCosmeticos() {
